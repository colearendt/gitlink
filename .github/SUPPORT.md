# Getting help with gitlink

Thanks for using gitlink. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/gitlink/issues) to make sure the 
